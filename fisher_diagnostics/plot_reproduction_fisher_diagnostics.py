...
"""
plot_reproduction_fisher_diagnostics.py
...
Run the plotting script after generating the datasets:
    ...
    python plot_reproduction:fisher_diagnostics.py
...
Example:
    ...
    python plot_reproduction_fisher_diagnostics.py --family XYZ
...
def plot_p_r1_vs_alpha_across_families(
    ...
    fig.tight_layout()
    #plt.savefig("Figure_FisherExponent_vs_Alpha_R1_XYZ.png", dpi=200)
...
def main():
    ...
    data_dir = args.data_dir or os.path.join(base_dir, "reproduction_data")
